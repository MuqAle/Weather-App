...
const helperFunction = (() => {
    ...
    const formatDate = (date) => {
        const newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date.split(' ')[0])
        const displayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(newDate, 'PPPP')
        return displayDate
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (helperFunction);
...
/* harmony import */ var _helper_fnc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helper_fnc */ "./src/helper_fnc.js");
...
const renderWeather = (() => {
    ...
    const domData = (weather) => {
        ...
        date.textContent = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].formatDate(weather.location.localtime)
        time.textContent = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].formatTime(weather.location.localtime)
        ...
        const number = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].getURL(weather.current.condition.icon)
        const dayURL = `./background_imgs/day_imgs/${_helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber()}.jpg`
        const nightURL = `./background_imgs/night_imgs/${_helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber()}.jpg`
    ...
    const tempMetric = () => {
        ...
        if(scale.className === 'celsius'){
            ...
            const cTemp = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].CToF(temp)
            const cFLTemp = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].CToF(fLTemp)
            const ktoM = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].kToM(wS)
            ...
            fLTemp = feelsLike.nextElementSibling.textContent
            wS = windSpeed.nextElementSibling.textContent
            const fTemp = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].FToC(temp)
            const fFLTemp = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].FToC(fLTemp)
            const mtoK = _helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].mToK(wS)
    ...
    const renderPage = async(city) => {
        try{
            const weatherForecast = await (0,_API__WEBPACK_IMPORTED_MODULE_0__["default"])(city)
...
_render__WEBPACK_IMPORTED_MODULE_0__["default"].renderPage('Beijing')
_render__WEBPACK_IMPORTED_MODULE_0__["default"].createWeatherAPP()

...
const renderWeather = (() => {
    ...
    const domData = (weather) => {
        ...
        const dayURL = String(`../background_imgs/day_imgs/${_helper_fnc__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber()}.jpg`)
